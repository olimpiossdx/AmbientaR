...
import {
  ...
  PCA_LISTAGEM_C_ACTIVITY_BY_TIPO,
  PCA_LISTAGEM_C_FORM_TIPO_PADRAO,
} from './pca-listagem-c-registry';
export function PcaFormListagemCGeral({ form }: { form: any }) {
  return (
    <PcaFormListagemGeralBase
      ...
      inferirFormulario={inferirFormularioPcaListagemC}
      activityByTipo={PCA_LISTAGEM_C_ACTIVITY_BY_TIPO}
      defaultTipo={PCA_LISTAGEM_C_FORM_TIPO_PADRAO}
    />
  );
}
