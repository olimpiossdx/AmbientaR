...
import { PCA_LISTAGEM_B_SUBACTIVITIES } from '@/lib/pca/pca-listagem-b-catalog';

type PcaFormListagemBShellProps = {
...
export function PcaFormListagemBShell({
  form,
  clients,
  projects,
  isLoadingClients,
      ...
      <AccordionItem value="identificacao">
        ...
        <AccordionContent className="space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Subatividade (Listagem B)</FormLabel>
                <Select onValueChange={field.onChange} value={field.value}>
                  ...
                  <SelectContent>
                    {PCA_LISTAGEM_B_SUBACTIVITIES.map((opt) => (
