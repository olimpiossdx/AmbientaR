...
export function FaunaManagementView() {
  ...
  return (
    <>
      <div className="flex flex-col h-full">
        <PageHeader title="Fauna ÔÇö Documentos Ambientais">
        ...
        <main className="flex-1 overflow-auto p-4 md:p-6">
          <Card>
            <CardHeader>
              <CardTitle>Relat├│rios e Licen├ºas Conclu├¡das</CardTitle>
              <CardDescription>
                Documentos conclu├¡dos pela consultoria e arquivos enviados pelo cliente. Estudos em elabora├º├úo ficam em {ESTUDOS_TECNICOS_MENU_LABEL} ÔåÆ Estudos de Fauna.
              </CardDescription>
              {showEntityFilter && (
                ...
                <div className="space-y-3 md:hidden">
                      ...
                      <CardContent className="p-4 space-y-3">
                        <div className="flex items-start justify-between gap-3">
                          <div className="min-w-0">
                            <p className="font-medium truncate">
                              {empreendedorMap.get(study.empreendedorId) || 'N├úo definido'}
                            </p>
                        ...
                        <div className="flex items-center gap-1">
                          <RecordViewDialog
                            ...
                            description="Visualiza├º├úo sem edi├º├úo."
                          ...
                          >
                            <div>
                              ...
                              <p className="font-medium">{empreendedorMap.get(study.empreendedorId) || 'ÔÇö'}</p>
                            </div>
                            <div>
                  ...
                  {!isLoading && displayedStudies?.length === 0 && (
                    <div className="h-24 flex items-center justify-center text-sm text-muted-foreground">
                      Nenhum estudo conclu├¡do encontrado.
                    </div>
                  )}
                </div>
                  ...
                  <TableBody>
                    ...
                    {!isLoading && displayedStudies?.map((study) => (
                      <TableRow key={study.id}>
                        <TableCell className="font-medium">{empreendedorMap.get(study.empreendedorId) || 'N├úo definido'}</TableCell>
                    ...
                    {!isLoading && displayedStudies?.length === 0 && (
                      <TableRow>
                        <TableCell colSpan={5} className="h-24 text-center">Nenhum estudo conclu├¡do encontrado.</TableCell>
                      </TableRow>
                    )}
                  </TableBody>
                </Table>
