...
export function FormListagemCPlasticosModulo4({ form }: { form: any }) {
  ...
  return (
    <div className="space-y-6">
      <SectionCard title="15. Planta de localização">
        ...
        <TextField form={form} name="listagemC.plasticos.anexoPlantaLocalizacao" label="Referência / observações (Anexo XVIII)" />
      </SectionCard>
      ...
      <SectionCard title="20 e 21. Croqui de acesso e justificativas">
        ...
        <TextField form={form} name="listagemC.plasticos.anexoCroquiAcesso" label="Referência croqui (Anexo XXVI)" />
        <TextField form={form} name="listagemC.plasticos.anexoJustificativas" label="Referência justificativas (Anexos XXVII–XXX)" />
      </SectionCard>
      ...
      <SectionCard title="23. Sigilo industrial">
        <FormField
          control={form.control}
        ...
        />
        {sigiloIndustrial && (
          <TextField form={form} name="listagemC.plasticos.sigiloIndustrialReferencia" label="Referência ao Anexo XXXI" />
        )}
      </SectionCard>

      <SectionCard title="24. Área do empreendimento">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <NumField form={form} name="listagemC.plasticos.areas.areaTotalM2" label="Área total do terreno (m²)" />
          <NumField form={form} name="listagemC.plasticos.areas.areaUtilM2" label="Área útil (m²)" />
          <NumField form={form} name="listagemC.plasticos.areas.areaConstruidaM2" label="Área construída (m²)" />
        </div>
        <FormDescription>
