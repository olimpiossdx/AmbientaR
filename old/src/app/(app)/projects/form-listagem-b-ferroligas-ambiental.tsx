...
export function FormListagemBFerroligasAmbiental({ form }: { form: any }) {
  ...
  return (
    <div className="space-y-6">
      <SectionCard title="40.1 Efluente de refrigeração industrial">
        <FormField
          control={form.control}
        ...
        {usaRefrigeracao && (
          <>
            ...
            />
            <CheckboxOptions form={form} name={`${base}.efluentes.refrigeracao.desaguamento`} options={opcoesDesaguamento} />
          </>
        )}
      </SectionCard>

      <SectionCard title="40.2 Efluente de lavadores de gases">
        <FormField
          control={form.control}
        ...
        {usaLavadorGases && (
          <>
            ...
            />
            <CheckboxOptions form={form} name={`${base}.efluentes.lavadorGases.desaguamento`} options={opcoesDesaguamento} />
            <FormField
              control={form.control}
      ...
      <SectionCard title="40.3 Efluentes oleosos">
        <FormField
          control={form.control}
          ...
          <>
            {unidadesOleosas.map((item, index) => (
              <div key={item.id} className="space-y-3 rounded-md border p-3">
                ...
                <TextField form={form} name={`${base}.efluentes.oleosos.unidades.${index}.nome`} label="Unidade / setor" />
                <FormField
                  control={form.control}
      ...
      <SectionCard title="40.4 Águas de lavagem de minérios">
        <FormField
          control={form.control}
        ...
        {lavagemMinerios && (
          <>
            <CheckboxOptions form={form} name={`${base}.efluentes.lavagemMinerios.desaguamento`} options={opcoesDesaguamento} />
            <TextField form={form} name={`${base}.efluentes.lavagemMinerios.corpoReceptor`} label="Corpo receptor (se curso d'água)" />
            <CaracterizacaoEfluenteAntesDepois
              form={form}
      ...
      <SectionCard title="40.5 Águas de purga de compressores">
        <FormField
          control={form.control}
        ...
        {purgaCompressores && (
          <>
            <CheckboxOptions form={form} name={`${base}.efluentes.purgaCompressores.desaguamento`} options={opcoesDesaguamento} />
            <CaracterizacaoEfluenteAntesDepois
              form={form}
      ...
      <SectionCard title="40.6 Efluentes sanitários">
        <FormField
          control={form.control}
        ...
        {tratamentoSanitario && (
          <>
            ...
            />
            <NumField form={form} name={`${base}.efluentes.sanitarios.usuariosDimensionados`} label="Usuários dimensionados" />
            <NumField form={form} name={`${base}.efluentes.sanitarios.numeroEstacoes`} label="Nº de estações de tratamento" />
            <CaracterizacaoEfluenteAntesDepois
              form={form}
      ...
      <SectionCard title="40.7 Águas pluviais">
        <FormField
          control={form.control}
        ...
        {drenagemPluvial && (
          <>
            ...
            />
            <CheckboxOptions form={form} name={`${base}.efluentes.pluviais.destino`} options={opcoesDesaguamento} />
          </>
        )}
      </SectionCard>
      ...
      <SectionCard title="42. Resíduos sólidos">
        <FormDescription>
        ...
        {residuosIndustriais.map((r) => (
          <div key={r.id} className="grid grid-cols-1 gap-3 rounded-md border p-3 md:grid-cols-4">
            ...
            <NumField form={form} name={`${base}.residuosSolidos.${r.id}.quantidadeKgMes`} label="Quantidade (kg/mês)" />
            <CheckboxOptions
              form={form}
            ...
            />
            <TextField form={form} name={`${base}.residuosSolidos.${r.id}.disposicaoArea`} label="Disposição na área (código 1–8)" />
            <TextField form={form} name={`${base}.residuosSolidos.${r.id}.destinacao`} label="Destinação final" />
          </div>
        ))}
        {residuosOutros.map((item, index) => (
          <div key={item.id} className="grid grid-cols-1 gap-3 rounded-md border p-3 md:grid-cols-4">
            <TextField form={form} name={`${base}.residuosSolidos.outros.${index}.residuo`} label="Outro resíduo" />
            <TextField form={form} name={`${base}.residuosSolidos.outros.${index}.fonte`} label="Fonte" />
            <NumField form={form} name={`${base}.residuosSolidos.outros.${index}.quantidadeKgMes`} label="kg/mês" />
        ...
        <div className="space-y-3 rounded-md border p-3">
          ...
          <NumField form={form} name={`${base}.residuosSolidos.lixoDomestico.quantidadeKgMes`} label="Quantidade gerada (kg/mês)" />
          <CheckboxOptions
            form={form}
          ...
          />
          {coletaSeletiva && (
            <TextField form={form} name={`${base}.residuosSolidos.coletaSeletivaDescricao`} label="Descrição da coleta seletiva" />
          )}
          <CheckboxOptions
            form={form}
