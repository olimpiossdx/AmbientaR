...
function TabelaRefrigeracao({ form }: { form: any }) {
  ...
  return (
    <SectionCard title="46.1 Efluente de resfriamento / refrigeração industrial">
      <FormField
          ...
          {equipamentosRefrigeracao.map((eq) => {
            ...
            return (
              <div key={slug} className="rounded-md border p-3">
                ...
                <CheckboxOptions form={form} name={`listagemB.efluentes.refrigeracao.${slug}.sistema`} options={opcoesRefrigeracao} />
                <TextField form={form} name={`listagemB.efluentes.refrigeracao.${slug}.sistemaOutros`} label="Outros – especificar" />
                <CheckboxOptions form={form} name={`listagemB.efluentes.refrigeracao.${slug}.desaguamento`} options={opcoesDesaguamento} />
                <TextField form={form} name={`listagemB.efluentes.refrigeracao.${slug}.desaguamentoOutros`} label="Desaguamento – outros" />
              </div>
            );
          })}
        </div>
...
function TabelaLavadorGases({ form }: { form: any }) {
  ...
  return (
    <SectionCard title="46.2 Efluente de lavadores de gases (controle de emissões via úmida)">
      <FormField
        control={form.control}
        ...
        <div className="space-y-4">
          {equipamentosLavadorGases.map((eq) => {
            ...
            return (
              <div key={slug} className="rounded-md border p-3">
                <p className="mb-2 font-medium">{eq}</p>
                <CheckboxOptions form={form} name={`listagemB.efluentes.lavadorGases.${slug}.tipo`} options={opcoesLavadorGases} />
                <CheckboxOptions form={form} name={`listagemB.efluentes.lavadorGases.${slug}.desaguamento`} options={opcoesDesaguamento} />
                <FormField
                  control={form.control}
...
export function FormListagemBAmbiental({ form }: { form: any }) {
  ...
  return (
    <div className="space-y-6">
      <SectionCard title="45. Equipamentos ou sistemas para geração de energia elétrica">
        <FormField
          control={form.control}
        ...
        {geraEnergia && (
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <NumField form={form} name="listagemB.energia.cogeracaoKw" label="Cogeração (kW)" />
            <NumField form={form} name="listagemB.energia.grupoGeradorKw" label="Grupo gerador (kW)" />
            <NumField form={form} name="listagemB.energia.outrasGeracaoKw" label="Outras formas in loco (kW)" />
            <TextField form={form} name="listagemB.energia.outrasGeracaoEspecificar" label="Outras – especificar" />
          </div>
        )}
        <CheckboxOptions
          form={form}
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <TextField form={form} name="listagemB.energia.empresaFornecedora" label="Nome da empresa fornecedora" />
          <NumField form={form} name="listagemB.energia.demandaContratadaKwhMes" label="Demanda contratada (kWh/mês)" />
          <NumField form={form} name="listagemB.energia.consumoMedioKwhMes" label="Consumo mensal médio (kWh/mês)" />
        </div>
        <FormField
          control={form.control}
        ...
        {form.watch('listagemB.energia.possuiSubestacao') && (
          <NumField form={form} name="listagemB.energia.tensaoSubestacaoKv" label="Tensão (kV)" />
        )}
      </SectionCard>
      ...
      <SectionCard title="Tratamento dos efluentes dos lavadores de gases">
        ...
        {equipamentosLavador.map((item, index) => (
          <div key={item.id} className="space-y-3 rounded-md border p-3">
            <TextField form={form} name={`listagemB.efluentes.tratamentoLavador.equipamentos.${index}.identificacao`} label={`Equipamento ${index + 1}`} />
            <FormField
              control={form.control}
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
              <NumField form={form} name={`listagemB.efluentes.tratamentoLavador.equipamentos.${index}.areaM2`} label="Área superfície (m²)" />
              <NumField form={form} name={`listagemB.efluentes.tratamentoLavador.equipamentos.${index}.alturaUtilM`} label="Altura útil (m)" />
              <NumField form={form} name={`listagemB.efluentes.tratamentoLavador.equipamentos.${index}.alturaTotalM`} label="Altura total (m)" />
              <NumField form={form} name={`listagemB.efluentes.tratamentoLavador.equipamentos.${index}.tempoResidenciaH`} label="Tempo de residência (h)" />
            </div>
      ...
      <SectionCard title="46.3 Efluentes oleosos">
        <FormField
          control={form.control}
      ...
      <SectionCard title="46.4 Efluentes de derramamentos (materiais líquidos/pastosos)">
        <FormField
          control={form.control}
      ...
      <SectionCard title="46.5 Efluentes do tratamento químico superficial">
        <FormField
          control={form.control}
          ...
          <>
            {processosQuimicos.map((item, index) => (
              <div key={item.id} className="space-y-3 rounded-md border p-3">
                ...
                <TextField form={form} name={`listagemB.efluentes.quimicoSuperficial.processos.${index}.nome`} label="Processo" />
                <FormField
                  control={form.control}
      ...
      <SectionCard title="Efluentes líquidos – tratamento geral">
        <FormField
          control={form.control}
      ...
      <SectionCard title="46.6 Efluentes sanitários">
        <FormField
          control={form.control}
        ...
        {sanitariosTratados && (
          <>
            ...
            />
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <NumField form={form} name="listagemB.efluentes.sanitarios.usuariosDimensionados" label="Dimensionado para quantos usuários?" />
              <NumField form={form} name="listagemB.efluentes.sanitarios.numEstacoes" label="Nº de estações de tratamento" />
            </div>
          </>
        )}
        <FormField
      ...
      <SectionCard title="46.7 Águas pluviais">
        <FormField
          control={form.control}
      ...
      <SectionCard title="47. Efluentes atmosféricos">
        <FormField
          control={form.control}
        ...
        {utilizaJateamento && (
          <>
            <NumField form={form} name="listagemB.emissoes.jateamento.quantidadeEquipamentos" label="Quantidade de equipamentos" />
        ...
        {fornosFusao.map((item, index) => (
          <div key={item.id} className="space-y-3 rounded-md border p-3">
            <TextField form={form} name={`listagemB.emissoes.fusao.fornos.${index}.identificacao`} label={`Forno de fusão ${index + 1}`} />
            <CheckboxOptions
              form={form}
      ...
      <SectionCard title="48. Resíduos sólidos">
        <FormField
          control={form.control}
        ...
        {utilizaMoldagemResiduo && (
          <>
            {processosAreiaMoldagem.map((item, index) => (
              <div key={item.id} className="space-y-3 rounded-md border p-3">
                <TextField form={form} name={`listagemB.residuos.areiaMoldagem.processos.${index}.identificacao`} label="Processo/tipo de areia" />
                <NumField form={form} name={`listagemB.residuos.areiaMoldagem.processos.${index}.quantidadeKgDia`} label="Areia descartada (Kg/dia)" />
                <NumField form={form} name={`listagemB.residuos.areiaMoldagem.processos.${index}.percentual`} label="Percentual em relação à areia utilizada (%)" />
        ...
        {utilizaMachariaResiduo && (
          <>
            {processosMacharia.map((item, index) => (
              <div key={item.id} className="space-y-3 rounded-md border p-3">
                <TextField form={form} name={`listagemB.residuos.areiaMacharia.processos.${index}.identificacao`} label="Processo/tipo de areia de machos" />
                <NumField form={form} name={`listagemB.residuos.areiaMacharia.processos.${index}.percentual`} label="Percentual descartado (%)" />
        ...
        {fornosEscoria.map((item, index) => (
          <div key={item.id} className="space-y-3 rounded-md border p-3">
            <TextField form={form} name={`listagemB.residuos.escoria.fornos.${index}.identificacao`} label="Forno de fusão" />
            <NumField form={form} name={`listagemB.residuos.escoria.fornos.${index}.quantidadeKgDia`} label="Escória gerada (Kg/dia)" />
            <NumField form={form} name={`listagemB.residuos.escoria.fornos.${index}.percentual`} label="Percentual em relação ao metal fundido (%)" />
        ...
        {utilizaControleUmido && (
          <>
            {equipamentosResiduoUmido.map((item, index) => (
              <div key={item.id} className="space-y-3 rounded-md border p-3">
                <TextField form={form} name={`listagemB.residuos.controleUmido.equipamentos.${index}.identificacao`} label="Equipamento/setor" />
                <NumField form={form} name={`listagemB.residuos.controleUmido.equipamentos.${index}.quantidadeKgMes`} label="Resíduo gerado (Kg/mês)" />
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <NumField form={form} name="listagemB.residuos.sucata.quantidadeKgMes" label="48.5 – Sucata metálica (Kg/mês)" />
          <NumField form={form} name="listagemB.residuos.sucata.percentual" label="Percentual em relação ao metal fundido (%)" />
          <DisposicaoTemporariaResiduo form={form} basePath="listagemB.residuos.sucata.disposicao" />
          <TextField form={form} name="listagemB.residuos.sucata.comercializacao" label="Destinos em comercialização (T/mês)" className="md:col-span-2" />
        </div>

        <div className="space-y-3 rounded-md border p-3">
          <p className="font-medium">48.6 – Lixo doméstico</p>
          <NumField form={form} name="listagemB.residuos.lixoDomestico.quantidadeKgMes" label="Quantidade (Kg/mês)" />
          <CheckboxOptions
            form={form}
      ...
      <SectionCard title="50. Cinturão verde / paisagismo">
        <FormField
          control={form.control}
      ...
      <SectionCard title="51. Passivos ambientais">
        <FormField
          control={form.control}
