...
- **Estado:** **Fases 0 e 1 implementadas** — workspaces/AOI, calendário INPE, montagem preview/GeoTIFF, biblioteca, pré-aquecimento. GDAL/recorte AOI real fica para iteração do worker.
