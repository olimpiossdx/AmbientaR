...
export function AuthHeroPanel() {
  return (
    <aside
      className="relative hidden min-h-screen flex-col justify-center overflow-hidden bg-linear-to-br from-primary via-emerald-800 to-emerald-500 px-10 py-12 lg:flex xl:px-14"
