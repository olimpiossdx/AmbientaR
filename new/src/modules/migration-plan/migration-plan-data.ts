...
export const migrationModules: MigrationModule[] = [
 {
  ...
  acceptance: [
   "Cada conjunto de claims renderiza o painel permitido",
  ...
  features: [
   {
    ...
    apiScope: "GET /dashboard com agregações autorizadas por claims.",
  ...
  features: [
   {
    ...
    apiScope: "GET /users, POST/PUT conforme claims.",
