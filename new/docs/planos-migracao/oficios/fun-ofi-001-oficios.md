...
Migrar a funcionalidade **Ofícios** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: recurso.oficio=*; numeração atômica; AC-WORKFLOW, AC-JOB.

## Hierarquia e rotas

- Módulo/menu pai: **Ofícios**.
- Filho/tela: **Ofícios**.
- Rotas alvo declaradas: /app/oficios, /new, /$id/edit.
- Claim do filho: recurso.oficio=*; numeração atômica; AC-WORKFLOW, AC-JOB.
...
- `web/src/app/(app)/oficios/[id]/edit/page.tsx`
- `web/src/app/(app)/oficios/new/page.tsx`
- `web/src/app/(app)/oficios/page.tsx`
...
- [ ] Registrar módulo, rotas lazy, item filho e breadcrumb no registro central, mantendo **Ofícios** como pai.
...
- [ ] Aplicar guard antes do carregamento e guard de ação para recurso.oficio=*; numeração atômica; AC-WORKFLOW, AC-JOB; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /official-letters; ações number/approve/send; exports.
...
- [ ] Regra específica validada: recurso.oficio=*; numeração atômica; AC-WORKFLOW, AC-JOB.
