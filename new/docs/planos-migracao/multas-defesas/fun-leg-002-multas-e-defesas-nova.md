# FUN-LEG-002 — Multas e Defesas / Nova
...
Migrar a funcionalidade **Multas e Defesas / Nova** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: defesa versionada, protocolo e documentos; AC-WORKFLOW, AC-FILE.

## Hierarquia e rotas

- Módulo/menu pai: **Multas e Defesas**.
- Filho/tela: **Multas e Defesas / Nova**.
- Rotas alvo declaradas: /app/multas-defesas/nova.
- Claim do filho: recurso.multa-defesa com criar/editar/protocolar.
...
- `web/src/app/(app)/multas-defesas/nova/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para recurso.multa-defesa com criar/editar/protocolar; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: POST /environmental-fines; ações e anexos.
...
- [ ] Regra específica validada: defesa versionada, protocolo e documentos; AC-WORKFLOW, AC-FILE.
