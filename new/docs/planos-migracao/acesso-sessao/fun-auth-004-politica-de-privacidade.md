# FUN-AUTH-004 — Política de privacidade
...
Migrar a funcionalidade **Política de privacidade** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: versão e vigência visíveis; aceite vinculável quando exigido.

## Hierarquia e rotas

- Módulo/menu pai: **Acesso e sessão**.
- Filho/tela: **Política de privacidade**.
- Rotas alvo declaradas: /politica-privacidade.
- Claim do filho: pública.
...
- `web/src/app/politica-privacidade/page.tsx`
...
Contrato alvo: GET /public/legal/privacy-policy.
...
- [ ] Regra específica validada: versão e vigência visíveis; aceite vinculável quando exigido.
