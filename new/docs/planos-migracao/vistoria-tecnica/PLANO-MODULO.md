# Plano do módulo — Vistoria Técnica

Status: análise inicial  
Diretório: `vistoria-tecnica`  
Dependência de acesso do pai: `modulo.vistoria=acessar`  
Filhos mapeados: **3**

## Objetivo

Migrar o menu **Vistoria Técnica** como módulo coeso do `new`, mantendo cada submenu/tela como entrega vertical separada. O módulo pai é responsável por registro, navegação e contexto compartilhado; regras de negócio permanecem nos domínios dos filhos e no `ambientaR-api`.

## Filhos do módulo

| Plano da funcionalidade | Rotas alvo | Contrato alvo |
| --- | --- | --- |
| [FUN-VIS-001 — Vistoria / Consultar](fun-vis-001-vistoria-consultar.md) | /app/inspections, /$id/edit | CRUD /inspections |
| [FUN-VIS-002 — Vistoria / Nova](fun-vis-002-vistoria-nova.md) | /app/inspections/new | POST /inspections |
| [FUN-VIS-003 — Vistoria / Relatórios de Campo](fun-vis-003-vistoria-relatorios-de-campo.md) | /app/inspections/reports | POST /inspections/{id}/report-jobs |
