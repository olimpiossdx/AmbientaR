...
Migrar a funcionalidade **Empreendedores** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: CPF/CNPJ, titularidade e vínculos; AC-CRUD.

## Hierarquia e rotas

- Módulo/menu pai: **Cadastro**.
- Filho/tela: **Empreendedores**.
- Rotas alvo declaradas: /app/empreendedores, /new, /$id/edit.
- Claim do filho: recurso.empreendedor=*.
...
- `web/src/app/(app)/empreendedores/[id]/edit/page.tsx`
- `web/src/app/(app)/empreendedores/new/page.tsx`
- `web/src/app/(app)/empreendedores/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para recurso.empreendedor=*; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /empreendedores.
...
- [ ] Regra específica validada: CPF/CNPJ, titularidade e vínculos; AC-CRUD.
