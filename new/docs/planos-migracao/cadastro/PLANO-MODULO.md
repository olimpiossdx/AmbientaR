...
Migrar o menu **Cadastro** como módulo coeso do `new`, mantendo cada submenu/tela como entrega vertical separada. O módulo pai é responsável por registro, navegação e contexto compartilhado; regras de negócio permanecem nos domínios dos filhos e no `ambientaR-api`.

## Filhos do módulo

| Plano da funcionalidade | Rotas alvo | Contrato alvo |
| --- | --- | --- |
| [FUN-CAD-001 — Usuários](fun-cad-001-usuarios.md) | /app/users e formulário/modal | CRUD existente /user; /authorization/groups; /authorization/claims |
| [FUN-CAD-002 — Empreendedores](fun-cad-002-empreendedores.md) | /app/empreendedores, /new, /$id/edit | CRUD /empreendedores |
| [FUN-CAD-003 — Empreendimentos](fun-cad-003-empreendimentos.md) | /app/projects, /new, /$id/edit | CRUD /empreendimentos |
| [FUN-CAD-004 — Empresas](fun-cad-004-empresas.md) | /app/responsible-company, /new, /$id/edit | CRUD /empresas-responsaveis |
...
- [ ] Todos os 4 planos filhos estão concluídos e possuem evidência.
