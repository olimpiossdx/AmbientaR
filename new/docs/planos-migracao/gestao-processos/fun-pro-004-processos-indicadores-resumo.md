# FUN-PRO-004 — Processos / Indicadores / Resumo
...
Migrar a funcionalidade **Processos / Indicadores / Resumo** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: agregação escopada; AC-READ.

## Hierarquia e rotas

- Módulo/menu pai: **Gestão de Projetos e Processos**.
- Filho/tela: **Processos / Indicadores / Resumo**.
- Rotas alvo declaradas: /app/gestao-processos/indicadores.
...
- `web/src/app/(app)/gestao-processos/indicadores/page.tsx`
...
Contrato alvo: GET /process-indicators/summary.
...
- [ ] Regra específica validada: agregação escopada; AC-READ.
