# FUN-FAD-004 — FAD / Linha do tempo
...
Migrar a funcionalidade **FAD / Linha do tempo** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: ordenação temporal e fonte; AC-CRUD.

## Hierarquia e rotas

- Módulo/menu pai: **IA / Fiscal Ambiental Digital**.
- Filho/tela: **FAD / Linha do tempo**.
- Rotas alvo declaradas: /app/ia/fiscal-ambiental-digital/linha-do-tempo.
- Claim do filho: recurso.fad-linha-tempo=*.
...
- `web/src/app/(app)/ia/fiscal-ambiental-digital/linha-do-tempo/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para recurso.fad-linha-tempo=*; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /fad/timeline-events.
...
- [ ] Regra específica validada: ordenação temporal e fonte; AC-CRUD.
