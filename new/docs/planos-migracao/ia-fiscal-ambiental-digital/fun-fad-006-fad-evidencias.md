...
Migrar a funcionalidade **FAD / Evidências** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: cadeia de custódia e checksum; AC-CRUD, AC-FILE.

## Hierarquia e rotas

- Módulo/menu pai: **IA / Fiscal Ambiental Digital**.
- Filho/tela: **FAD / Evidências**.
- Rotas alvo declaradas: /app/ia/fiscal-ambiental-digital/evidencias.
- Claim do filho: recurso.fad-evidencia=*.
...
- `web/src/app/(app)/ia/fiscal-ambiental-digital/evidencias/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para recurso.fad-evidencia=*; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /fad/evidence.
...
- [ ] Regra específica validada: cadeia de custódia e checksum; AC-CRUD, AC-FILE.
