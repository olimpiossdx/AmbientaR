...
Migrar a funcionalidade **FAD / Relatórios** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.
...
- Filho/tela: **FAD / Relatórios**.
- Rotas alvo declaradas: /app/ia/fiscal-ambiental-digital/relatorios.
- Claim do filho: recurso.fad-relatorio com visualizar/exportar.
...
- `web/src/app/(app)/ia/fiscal-ambiental-digital/relatorios/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para recurso.fad-relatorio com visualizar/exportar; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: POST /fad/report-jobs, GET /fad/reports.
