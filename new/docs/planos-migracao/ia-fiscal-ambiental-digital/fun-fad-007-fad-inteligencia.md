...
Migrar a funcionalidade **FAD / Inteligência** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: modelo/fonte/custo registrados; AC-JOB.

## Hierarquia e rotas

- Módulo/menu pai: **IA / Fiscal Ambiental Digital**.
- Filho/tela: **FAD / Inteligência**.
- Rotas alvo declaradas: /app/ia/fiscal-ambiental-digital/inteligencia.
- Claim do filho: recurso.fad-inteligencia=executar.
...
- `web/src/app/(app)/ia/fiscal-ambiental-digital/inteligencia/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para recurso.fad-inteligencia=executar; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: POST /fad/intelligence-jobs.
...
- [ ] Regra específica validada: modelo/fonte/custo registrados; AC-JOB.
