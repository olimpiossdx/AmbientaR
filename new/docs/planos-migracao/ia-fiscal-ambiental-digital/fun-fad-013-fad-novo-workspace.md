# FUN-FAD-013 — FAD / Novo workspace
...
Migrar a funcionalidade **FAD / Novo workspace** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: AC-CRUD.

## Hierarquia e rotas

- Módulo/menu pai: **IA / Fiscal Ambiental Digital**.
- Filho/tela: **FAD / Novo workspace**.
- Rotas alvo declaradas: /app/ia/fiscal-ambiental-digital/workspace/novo.
- Claim do filho: recurso.fad-workspace=criar.
...
- `web/src/app/(app)/ia/fiscal-ambiental-digital/workspace/[workspaceId]/page.tsx`
- `web/src/app/(app)/ia/fiscal-ambiental-digital/workspace/novo/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para recurso.fad-workspace=criar; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: POST /fad/workspaces.
...
- [ ] Regra específica validada: AC-CRUD.
