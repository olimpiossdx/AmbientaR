# FUN-IA-003 — Análise Socioambiental
...
Migrar a funcionalidade **Análise Socioambiental** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: ondas/fontes registradas; AC-JOB.

## Hierarquia e rotas

- Módulo/menu pai: **IA**.
- Filho/tela: **Análise Socioambiental**.
- Rotas alvo declaradas: /app/studies/analise-socioambiental.
- Claim do filho: recurso.analise-socioambiental=executar.
...
- `web/src/app/(app)/studies/analise-socioambiental/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para recurso.analise-socioambiental=executar; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: POST /socio-environmental-analysis-jobs.
...
- [ ] Regra específica validada: ondas/fontes registradas; AC-JOB.
