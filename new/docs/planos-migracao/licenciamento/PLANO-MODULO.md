# Plano do módulo — Licenciamento

Status: análise inicial  
Diretório: `licenciamento`  
Dependência de acesso do pai: `modulo.licenciamento=acessar`  
Filhos mapeados: **3**

## Objetivo

Migrar o menu **Licenciamento** como módulo coeso do `new`, mantendo cada submenu/tela como entrega vertical separada. O módulo pai é responsável por registro, navegação e contexto compartilhado; regras de negócio permanecem nos domínios dos filhos e no `ambientaR-api`.

## Filhos do módulo

| Plano da funcionalidade | Rotas alvo | Contrato alvo |
| --- | --- | --- |
| [FUN-LIC-001 — Licenciamento / Trâmites](fun-lic-001-licenciamento-tramites.md) | /app/requests, /$id/edit | CRUD /licensing-requests; ações |
| [FUN-LIC-002 — Licenciamento / Nova solicitação](fun-lic-002-licenciamento-nova-solicitacao.md) | /app/requests/new | POST /licensing-requests |
| [FUN-LIC-003 — Licenciamento / AIA](fun-lic-003-licenciamento-aia.md) | /app/requests/$id/aia | GET/PUT /licensing-requests/{id}/aia |
...
- [ ] Todos os 3 planos filhos estão concluídos e possuem evidência.
