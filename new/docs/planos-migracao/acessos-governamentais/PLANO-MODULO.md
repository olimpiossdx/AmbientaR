# Plano do módulo — Acessos Governamentais

Status: análise inicial  
Diretório: `acessos-governamentais`  
Dependência de acesso do pai: `modulo.acessos-governamentais=acessar`  
Filhos mapeados: **8**

## Objetivo

Migrar o menu **Acessos Governamentais** como módulo coeso do `new`, mantendo cada submenu/tela como entrega vertical separada. O módulo pai é responsável por registro, navegação e contexto compartilhado; regras de negócio permanecem nos domínios dos filhos e no `ambientaR-api`.

## Filhos do módulo

| Plano da funcionalidade | Rotas alvo | Contrato alvo |
| --- | --- | --- |
| [FUN-GOV-001 — Consulta Intervenção Ambiental](fun-gov-001-consulta-intervencao-ambiental.md) | /app/external?target=gov-intervencao | GET /external-targets/gov-intervencao |
| [FUN-GOV-002 — Consulta Licenciamento](fun-gov-002-consulta-licenciamento.md) | /app/external?target=gov-licenciamento | GET /external-targets/gov-licenciamento |
| [FUN-GOV-003 — Consulta Outorgas](fun-gov-003-consulta-outorgas.md) | /app/external?target=gov-outorgas | GET /external-targets/gov-outorgas |
| [FUN-GOV-004 — CTF/IBAMA externo](fun-gov-004-ctf-ibama-externo.md) | /app/external?target=gov-ctf | GET /external-targets/gov-ctf |
| [FUN-GOV-005 — IDE-SisemaNet externo](fun-gov-005-ide-sisemanet-externo.md) | /app/external?target=gov-ide | GET /external-targets/gov-ide |
| [FUN-GOV-006 — SEI-IBAMA](fun-gov-006-sei-ibama.md) | /app/external?target=gov-sei-ibama | GET /external-targets/gov-sei-ibama |
| [FUN-GOV-007 — SEI-MG](fun-gov-007-sei-mg.md) | /app/external?target=gov-sei-mg | GET /external-targets/gov-sei-mg |
| [FUN-GOV-008 — SLA Ecossistemas](fun-gov-008-sla-ecossistemas.md) | /app/external?target=gov-sla | GET /external-targets/gov-sla |
...
- [ ] Todos os 8 planos filhos estão concluídos e possuem evidência.
