# FUN-CRM-003 — Equipe e desempenho
...
Migrar a funcionalidade **Equipe e desempenho** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: recurso.crm-equipe com visualizar/editar; AC-READ.

## Hierarquia e rotas

- Módulo/menu pai: **Vendas & CRM**.
- Filho/tela: **Equipe e desempenho**.
- Rotas alvo declaradas: /app/crm/team.
- Claim do filho: recurso.crm-equipe com visualizar/editar; AC-READ.
...
- `web/src/app/(app)/crm/team/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para recurso.crm-equipe com visualizar/editar; AC-READ; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: GET /crm/team-performance; metas CRUD.
...
- [ ] Regra específica validada: recurso.crm-equipe com visualizar/editar; AC-READ.
