...
Regra funcional levantada: API retorna somente widgets autorizados e agregados já escopados; AC-READ, AC-FRONT.

## Hierarquia e rotas

- Módulo/menu pai: **Painel e Carteira**.
- Filho/tela: **Painel**.
- Rotas alvo declaradas: /app.
- Claim do filho: recurso.dashboard=visualizar.
...
- [ ] Regra específica validada: API retorna somente widgets autorizados e agregados já escopados; AC-READ, AC-FRONT.
