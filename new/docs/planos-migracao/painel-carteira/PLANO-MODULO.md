# Plano do módulo — Painel e Carteira

Status: análise inicial  
Diretório: `painel-carteira`  
Dependência de acesso do pai: `entrada principal`  
Filhos mapeados: **2**

## Objetivo

Migrar o menu **Painel e Carteira** como módulo coeso do `new`, mantendo cada submenu/tela como entrega vertical separada. O módulo pai é responsável por registro, navegação e contexto compartilhado; regras de negócio permanecem nos domínios dos filhos e no `ambientaR-api`.

## Filhos do módulo

| Plano da funcionalidade | Rotas alvo | Contrato alvo |
| --- | --- | --- |
| [FUN-CORE-001 — Painel](fun-core-001-painel.md) | /app | GET /dashboard |
| [FUN-CORE-002 — Minha Carteira](fun-core-002-minha-carteira.md) | /app/carteira, /app/carteira/$clientId | GET /carteira, GET /carteira/{clientId} |
