# Plano do módulo — Estudos Técnicos / Inventários de campo

Status: análise inicial  
Diretório: `inventarios-campo`  
Dependência de acesso do pai: `modulo.estudos-tecnicos=acessar + recurso.inventario-campo=*`  
Filhos mapeados: **1**

## Objetivo

Migrar o menu **Estudos Técnicos / Inventários de campo** como módulo coeso do `new`, mantendo cada submenu/tela como entrega vertical separada. O módulo pai é responsável por registro, navegação e contexto compartilhado; regras de negócio permanecem nos domínios dos filhos e no `ambientaR-api`.

## Filhos do módulo

| Plano da funcionalidade | Rotas alvo | Contrato alvo |
| --- | --- | --- |
| [FUN-INV-001 — Inventários de campo](fun-inv-001-inventarios-de-campo.md) | /app/inventarios, /new, /$id, /$id/parcelas/$parcelaId | CRUD /field-inventories; plots |
