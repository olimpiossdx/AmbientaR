# FUN-FIN-020 — Curva ABC de Serviços
...
Migrar a funcionalidade **Curva ABC de Serviços** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.
...
- Filho/tela: **Curva ABC de Serviços**.
- Rotas alvo declaradas: /app/financial/abc-servicos.
...
- `web/src/app/(app)/financial/abc-servicos/page.tsx`
...
Contrato alvo: GET /financial/reports/abc-services.
