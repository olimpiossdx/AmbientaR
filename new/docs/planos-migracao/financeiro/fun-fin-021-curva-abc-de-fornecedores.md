# FUN-FIN-021 — Curva ABC de Fornecedores
...
Migrar a funcionalidade **Curva ABC de Fornecedores** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.
...
- Filho/tela: **Curva ABC de Fornecedores**.
- Rotas alvo declaradas: /app/financial/abc-fornecedores.
...
- `web/src/app/(app)/financial/abc-fornecedores/page.tsx`
...
Contrato alvo: GET /financial/reports/abc-suppliers.
