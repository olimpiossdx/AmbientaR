...
Migrar a funcionalidade **Fornecedores** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: documento e dados bancários validados/mascarados; AC-CRUD.

## Hierarquia e rotas

- Módulo/menu pai: **Financeiro**.
- Filho/tela: **Fornecedores**.
- Rotas alvo declaradas: /app/suppliers, /new, /$id/edit.
- Claim do filho: recurso.fornecedor=*.
...
- `web/src/app/(app)/suppliers/[id]/edit/page.tsx`
- `web/src/app/(app)/suppliers/new/page.tsx`
- `web/src/app/(app)/suppliers/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para recurso.fornecedor=*; não usar `role`, `isAdmin` ou Firebase como autorização.
...
- [ ] Regra específica validada: documento e dados bancários validados/mascarados; AC-CRUD.
