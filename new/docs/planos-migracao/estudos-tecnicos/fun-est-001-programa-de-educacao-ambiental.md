# FUN-EST-001 — Programa de Educação Ambiental
...
Migrar a funcionalidade **Programa de Educação Ambiental** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: projeto, público, cronograma e fluxo de dispensa; AC-WORKFLOW.

## Hierarquia e rotas

- Módulo/menu pai: **Estudos Técnicos**.
- Filho/tela: **Programa de Educação Ambiental**.
- Rotas alvo declaradas: /app/studies/educacao-ambiental, /novo, /$id/edit, /solicitar-dispensa, /dispensas/$id.
- Claim do filho: proposta: recurso.estudo-programa-de-educacao-ambiental=*; validar no refinamento.
...
- `web/src/app/(app)/studies/educacao-ambiental/[id]/edit/page.tsx`
- `web/src/app/(app)/studies/educacao-ambiental/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para proposta: recurso.estudo-programa-de-educacao-ambiental=*; validar no refinamento; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /studies/environmental-education; /waivers; exports.
...
- [ ] Regra específica validada: projeto, público, cronograma e fluxo de dispensa; AC-WORKFLOW.
