# FUN-EST-047 — Compensação / Minerária
...
Migrar a funcionalidade **Compensação / Minerária** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: empreendimento e cálculo; AC-CRUD.

## Hierarquia e rotas

- Módulo/menu pai: **Estudos Técnicos**.
- Filho/tela: **Compensação / Minerária**.
- Rotas alvo declaradas: /app/studies/compensacao-ambiental/mineraria.
- Claim do filho: proposta: recurso.estudo-compensacao-mineraria=*; validar no refinamento.
...
- [ ] Aplicar guard antes do carregamento e guard de ação para proposta: recurso.estudo-compensacao-mineraria=*; validar no refinamento; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /environmental-compensations/mining.
...
- [ ] Regra específica validada: empreendimento e cálculo; AC-CRUD.
