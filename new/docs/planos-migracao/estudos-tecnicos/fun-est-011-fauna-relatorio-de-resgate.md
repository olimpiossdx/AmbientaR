# FUN-EST-011 — Fauna / Relatório de Resgate
...
Migrar a funcionalidade **Fauna / Relatório de Resgate** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.
...
- Filho/tela: **Fauna / Relatório de Resgate**.
- Rotas alvo declaradas: /app/studies/fauna/resgate-relatorio, /$id.
- Claim do filho: proposta: recurso.estudo-fauna-relatorio-de-resgate=*; validar no refinamento.
...
- `web/src/app/(app)/studies/fauna/resgate-relatorio/[id]/page.tsx`
- `web/src/app/(app)/studies/fauna/resgate-relatorio/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para proposta: recurso.estudo-fauna-relatorio-de-resgate=*; validar no refinamento; não usar `role`, `isAdmin` ou Firebase como autorização.
