...
Migrar a funcionalidade **LAS-RAS** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: formulário e anexos versionados; AC-CRUD, AC-JOB.

## Hierarquia e rotas

- Módulo/menu pai: **Estudos Técnicos**.
- Filho/tela: **LAS-RAS**.
- Rotas alvo declaradas: /app/studies/las-ras, /new, /$id/edit.
- Claim do filho: proposta: recurso.estudo-las-ras=*; validar no refinamento.
...
- `web/src/app/(app)/studies/las-ras/[id]/edit/page.tsx`
- `web/src/app/(app)/studies/las-ras/new/page.tsx`
- `web/src/app/(app)/studies/las-ras/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para proposta: recurso.estudo-las-ras=*; validar no refinamento; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /studies/las-ras; exports.
...
- [ ] Regra específica validada: formulário e anexos versionados; AC-CRUD, AC-JOB.
