# FUN-EST-032 — Barragens / Projeto técnico
...
Migrar a funcionalidade **Barragens / Projeto técnico** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: geometria, estruturas, hidrologia e versão; AC-JOB.

## Hierarquia e rotas

- Módulo/menu pai: **Estudos Técnicos**.
- Filho/tela: **Barragens / Projeto técnico**.
- Rotas alvo declaradas: /app/studies/barragem, /new, /$id/edit.
- Claim do filho: proposta: recurso.estudo-barragens-projeto-tecnico=*; validar no refinamento.
...
- `web/src/app/(app)/studies/barragem/[id]/edit/page.tsx`
- `web/src/app/(app)/studies/barragem/new/page.tsx`
- `web/src/app/(app)/studies/barragem/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para proposta: recurso.estudo-barragens-projeto-tecnico=*; validar no refinamento; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /dam-projects; calculation/export jobs.
...
- [ ] Regra específica validada: geometria, estruturas, hidrologia e versão; AC-JOB.
