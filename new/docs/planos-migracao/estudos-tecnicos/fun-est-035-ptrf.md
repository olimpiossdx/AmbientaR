...
Migrar a funcionalidade **PTRF** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: intervenção, recomposição e cronograma; AC-CRUD, AC-JOB.

## Hierarquia e rotas

- Módulo/menu pai: **Estudos Técnicos**.
- Filho/tela: **PTRF**.
- Rotas alvo declaradas: /app/studies/ptrf, /new, /$id/edit.
- Claim do filho: proposta: recurso.estudo-ptrf=*; validar no refinamento.
...
- `web/src/app/(app)/studies/ptrf/(.)[id]/edit/page.tsx`
- `web/src/app/(app)/studies/ptrf/(.)new/page.tsx`
- `web/src/app/(app)/studies/ptrf/[id]/edit/page.tsx`
- `web/src/app/(app)/studies/ptrf/new/page.tsx`
- `web/src/app/(app)/studies/ptrf/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para proposta: recurso.estudo-ptrf=*; validar no refinamento; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /studies/ptrf; exports.
...
- [ ] Regra específica validada: intervenção, recomposição e cronograma; AC-CRUD, AC-JOB.
