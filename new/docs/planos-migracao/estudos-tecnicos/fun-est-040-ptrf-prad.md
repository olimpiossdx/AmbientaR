...
Migrar a funcionalidade **PTRF/PRAD** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.
...
- Filho/tela: **PTRF/PRAD**.
- Rotas alvo declaradas: /app/studies/relatorios-diversos/ptrf-prad.
- Claim do filho: proposta: recurso.estudo-ptrf-prad=*; validar no refinamento.
...
- `web/src/app/(app)/studies/relatorios-diversos/ptrf-prad/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para proposta: recurso.estudo-ptrf-prad=*; validar no refinamento; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /misc-reports/ptrf-prad; exports.
