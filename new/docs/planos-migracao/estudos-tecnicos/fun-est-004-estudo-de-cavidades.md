# FUN-EST-004 — Estudo de Cavidades
...
Migrar a funcionalidade **Estudo de Cavidades** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: coordenadas, relevância e fontes; AC-CRUD, AC-JOB.

## Hierarquia e rotas

- Módulo/menu pai: **Estudos Técnicos**.
- Filho/tela: **Estudo de Cavidades**.
- Rotas alvo declaradas: /app/studies/cavidades, /new, /$id/edit.
- Claim do filho: proposta: recurso.estudo-estudo-de-cavidades=*; validar no refinamento.
...
- `web/src/app/(app)/studies/cavidades/[id]/edit/page.tsx`
- `web/src/app/(app)/studies/cavidades/new/page.tsx`
- `web/src/app/(app)/studies/cavidades/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para proposta: recurso.estudo-estudo-de-cavidades=*; validar no refinamento; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /studies/caves; analysis/exports.
...
- [ ] Regra específica validada: coordenadas, relevância e fontes; AC-CRUD, AC-JOB.
