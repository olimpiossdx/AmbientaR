# FUN-EST-024 — Memorial Descritivo
...
Regra funcional levantada: polígono fechado, azimute, distância e CRS; AC-JOB.

## Hierarquia e rotas

- Módulo/menu pai: **Estudos Técnicos**.
- Filho/tela: **Memorial Descritivo**.
- Rotas alvo declaradas: /app/studies/memorial-descritivo.
- Claim do filho: proposta: recurso.estudo-memorial-descritivo=*; validar no refinamento.
...
- `web/src/app/(app)/studies/memorial-descritivo/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para proposta: recurso.estudo-memorial-descritivo=*; validar no refinamento; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /descriptive-memorials; calculation/export jobs.
...
- [ ] Regra específica validada: polígono fechado, azimute, distância e CRS; AC-JOB.
