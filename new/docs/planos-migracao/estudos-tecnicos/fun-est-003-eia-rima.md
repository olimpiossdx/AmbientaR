...
Migrar a funcionalidade **EIA/RIMA** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: versão, capítulos, equipe e anexos; AC-CRUD, AC-JOB.

## Hierarquia e rotas

- Módulo/menu pai: **Estudos Técnicos**.
- Filho/tela: **EIA/RIMA**.
- Rotas alvo declaradas: /app/studies/eia-rima, /new, /$id/edit.
- Claim do filho: proposta: recurso.estudo-eia-rima=*; validar no refinamento.
...
- `web/src/app/(app)/studies/eia-rima/(.)[id]/edit/page.tsx`
- `web/src/app/(app)/studies/eia-rima/(.)new/page.tsx`
- `web/src/app/(app)/studies/eia-rima/[id]/edit/page.tsx`
- `web/src/app/(app)/studies/eia-rima/new/page.tsx`
- `web/src/app/(app)/studies/eia-rima/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para proposta: recurso.estudo-eia-rima=*; validar no refinamento; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /studies/eia-rima; exports.
...
- [ ] Regra específica validada: versão, capítulos, equipe e anexos; AC-CRUD, AC-JOB.
