# FUN-EST-009 — Fauna / Relatório de Monitoramento
...
Migrar a funcionalidade **Fauna / Relatório de Monitoramento** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: AC-JOB.

## Hierarquia e rotas

- Módulo/menu pai: **Estudos Técnicos**.
- Filho/tela: **Fauna / Relatório de Monitoramento**.
- Rotas alvo declaradas: /app/studies/fauna/monitoramento-relatorio, /$id.
- Claim do filho: proposta: recurso.estudo-fauna-relatorio-de-monitoramento=*; validar no refinamento.
...
- `web/src/app/(app)/studies/fauna/monitoramento-relatorio/[id]/page.tsx`
- `web/src/app/(app)/studies/fauna/monitoramento-relatorio/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para proposta: recurso.estudo-fauna-relatorio-de-monitoramento=*; validar no refinamento; não usar `role`, `isAdmin` ou Firebase como autorização.
...
- [ ] Regra específica validada: AC-JOB.
