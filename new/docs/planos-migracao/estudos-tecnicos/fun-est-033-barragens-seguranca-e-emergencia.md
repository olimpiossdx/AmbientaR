# FUN-EST-033 — Barragens / Segurança e emergência
...
Migrar a funcionalidade **Barragens / Segurança e emergência** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: cenários, classificação e plano; AC-JOB, AC-FILE.

## Hierarquia e rotas

- Módulo/menu pai: **Estudos Técnicos**.
- Filho/tela: **Barragens / Segurança e emergência**.
- Rotas alvo declaradas: /app/studies/seguranca-barragens, /new, /$id/edit.
- Claim do filho: proposta: recurso.estudo-barragens-seguranca-e-emergencia=*; validar no refinamento.
...
- `web/src/app/(app)/studies/seguranca-barragens/[id]/edit/page.tsx`
- `web/src/app/(app)/studies/seguranca-barragens/new/page.tsx`
- `web/src/app/(app)/studies/seguranca-barragens/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para proposta: recurso.estudo-barragens-seguranca-e-emergencia=*; validar no refinamento; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /dam-safety-plans; HEC-RAS/export jobs.
...
- [ ] Regra específica validada: cenários, classificação e plano; AC-JOB, AC-FILE.
