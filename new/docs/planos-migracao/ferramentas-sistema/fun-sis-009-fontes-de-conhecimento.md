# FUN-SIS-009 — Fontes de conhecimento
...
Migrar a funcionalidade **Fontes de conhecimento** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: recurso.fonte-conhecimento=*; versão, origem e índice; AC-JOB.

## Hierarquia e rotas

- Módulo/menu pai: **Ferramentas do Sistema**.
- Filho/tela: **Fontes de conhecimento**.
- Rotas alvo declaradas: /app/knowledge-sources, /new, /$id.
- Claim do filho: recurso.fonte-conhecimento=*; versão, origem e índice; AC-JOB.
...
- `web/src/app/(app)/knowledge-sources/[id]/page.tsx`
- `web/src/app/(app)/knowledge-sources/new/page.tsx`
- `web/src/app/(app)/knowledge-sources/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para recurso.fonte-conhecimento=*; versão, origem e índice; AC-JOB; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /knowledge-sources; indexing jobs.
...
- [ ] Regra específica validada: recurso.fonte-conhecimento=*; versão, origem e índice; AC-JOB.
