...
Migrar a funcionalidade **Laudos** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: recurso.laudo=*; AC-CRUD, AC-JOB.

## Hierarquia e rotas

- Módulo/menu pai: **Ferramentas do Sistema**.
- Filho/tela: **Laudos**.
- Rotas alvo declaradas: /app/laudos, /new, /$id.
- Claim do filho: recurso.laudo=*; AC-CRUD, AC-JOB.
...
- `web/src/app/(app)/laudos/[id]/page.tsx`
- `web/src/app/(app)/laudos/new/page.tsx`
- `web/src/app/(app)/laudos/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para recurso.laudo=*; AC-CRUD, AC-JOB; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /technical-reports; report jobs.
...
- [ ] Regra específica validada: recurso.laudo=*; AC-CRUD, AC-JOB.
