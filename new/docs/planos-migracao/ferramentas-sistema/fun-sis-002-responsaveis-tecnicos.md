# FUN-SIS-002 — Responsáveis técnicos
...
Migrar a funcionalidade **Responsáveis técnicos** do `web` para o `new`, sem dependência de Firebase nem das rotas Next.js do legado. O corte deve ser vertical: navegação, telas, serviço HTTP, contrato, autorização, persistência, testes e observabilidade entram na mesma entrega.

Regra funcional levantada: recurso.responsavel-tecnico=*; conselho/registro únicos; AC-CRUD.

## Hierarquia e rotas

- Módulo/menu pai: **Ferramentas do Sistema**.
- Filho/tela: **Responsáveis técnicos**.
- Rotas alvo declaradas: /app/technical-responsible, /new, /$id/edit.
- Claim do filho: recurso.responsavel-tecnico=*; conselho/registro únicos; AC-CRUD.
...
- `web/src/app/(app)/technical-responsible/(.)[id]/edit/page.tsx`
- `web/src/app/(app)/technical-responsible/(.)new/page.tsx`
- `web/src/app/(app)/technical-responsible/[id]/edit/page.tsx`
- `web/src/app/(app)/technical-responsible/new/page.tsx`
- `web/src/app/(app)/technical-responsible/page.tsx`
...
- [ ] Aplicar guard antes do carregamento e guard de ação para recurso.responsavel-tecnico=*; conselho/registro únicos; AC-CRUD; não usar `role`, `isAdmin` ou Firebase como autorização.
...
Contrato alvo: CRUD /technical-responsibles.
...
- [ ] Regra específica validada: recurso.responsavel-tecnico=*; conselho/registro únicos; AC-CRUD.
