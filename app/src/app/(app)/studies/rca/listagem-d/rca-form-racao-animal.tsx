...
interface RcaFormRacaoAnimalProps {
    form: any;
    clients: Client[];
...
export function RcaFormRacaoAnimal({ form, clients, isLoadingClients, projects, isLoadingProjects }: RcaFormRacaoAnimalProps) {
            ...
            <AccordionItem value="item-4">
                ...
                <AccordionContent className="space-y-6 p-1">
                    <div className="space-y-4 p-4 border rounded-md">
                     ...
                     <div className="space-y-4 p-4 border rounded-md">
                        <h3 className="font-semibold">20. MATÉRIAS-PRIMAS E INSUMOS</h3>
                        ...
                        {materiasPrimasFields.map((item, index) => (
                            <div key={item.id} className="p-2 border rounded-md space-y-2 relative">
                                ...
                                <FormField control={form.control} name={`materiasPrimas.${index}.embalagem`} render={({ field }: any) => (<FormItem><FormLabel>Tipo de Embalagem</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
                                <FormField control={form.control} name={`materiasPrimas.${index}.armazenamento`} render={({ field }: any) => (<FormItem><FormLabel>Local de Armazenamento</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
                    ...
                    <div className="space-y-4 p-4 border rounded-md">
                        <h3 className="font-semibold">21. PRODUTOS</h3>
                        <div className="flex justify-end">
