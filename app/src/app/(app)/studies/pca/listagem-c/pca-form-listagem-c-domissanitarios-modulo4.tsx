...
export function PcaFormListagemCDomissanitariosModulo4({ form }: { form: any }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <PcaSectionCard title="17. Tipo de ocupação da área de entorno">
        ...
        <PcaTextField form={form} name="listagemC.domissanitarios.anexoPlantaGeorreferenciada" label="Referência planta (Anexo XXIV)" />
      </PcaSectionCard>

      <PcaSectionCard title="18. Caracterização frente à legislação municipal">
        <FormField
          control={form.control}
      ...
      <PcaSectionCard title="20. Croqui para orientar o acesso">
        <FormDescription>Apresentar croqui de acesso no Anexo XXV.</FormDescription>
        <PcaTextField form={form} name="listagemC.domissanitarios.anexoCroquiAcesso" label="Referência croqui (Anexo XXV)" />
      </PcaSectionCard>

      <PcaSectionCard title="21. Justificativas">
        <FormDescription>
          Anexos XXVI a XXIX – justificativas tecnológica, técnico/socioeconômica, ambiental e locacional.
        </FormDescription>
        <PcaTextField form={form} name="listagemC.domissanitarios.anexoJustificativas" label="Referência justificativas (Anexos XXVI–XXIX)" />
      </PcaSectionCard>
      ...
      <PcaSectionCard title="23. Área do empreendimento">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <PcaNumField form={form} name="listagemC.domissanitarios.areas.areaTotalM2" label="Área total do terreno (m²)" />
          <PcaNumField form={form} name="listagemC.domissanitarios.areas.areaUtilM2" label="Área útil (m²)" />
          <PcaNumField form={form} name="listagemC.domissanitarios.areas.areaConstruidaM2" label="Área construída (m²)" />
        </div>
      </PcaSectionCard>
    </div>
  );
