...
export const pcaListagemCTecnicoSchema = z.any().optional();

export const pcaListagemCFormSchema = z
  .object({
  ...
  listagemC: pcaListagemCTecnicoSchema,
}).passthrough();

export type PcaListagemCFormValues = z.infer<typeof pcaListagemCFormSchema>;

export function getPcaListagemCDefaultValues(
  partial?: Partial<PcaListagemCFormValues> | null,
): PcaListagemCFormValues {
  return {
    status: 'Rascunho',
    listagemCode: 'C',
    activity: partial?.activity || PCA_LISTAGEM_C_ACTIVITY,
