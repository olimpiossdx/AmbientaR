...
export function PcaFormListagemCModulo4Complemento({ form }: { form: any }) {
  ...
  return (
    <div className="space-y-6">
      <PcaSectionCard title="15. Relacionamento da empresa com a comunidade">
        <PcaCheckboxOptions
          form={form}
        ...
        {form.watch('listagemC.relacionamentoComunidade.possuiTac') && (
          <PcaTextField form={form} name="listagemC.relacionamentoComunidade.instituicaoTac" label="Instituição (Anexo XX)" />
        )}
        <FormField
          control={form.control}
        ...
        {programaParceria && (
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            <PcaTextField form={form} name="listagemC.relacionamentoComunidade.nomePrograma" label="Qual é o programa?" />
            <PcaTextField form={form} name="listagemC.relacionamentoComunidade.tempoPrograma" label="Há quanto tempo / a partir de quando" />
          </div>
        )}
      </PcaSectionCard>
      ...
      <PcaSectionCard title="17 (cont.) Recursos hídricos no entorno">
      ...
      <PcaSectionCard title="18. Usos anteriores do terreno">
        <FormField
          control={form.control}
      ...
      <PcaSectionCard title="19 e 20. Croqui de acesso e justificativas">
        <FormDescription>
          Anexo XXV – croqui de acesso; Anexos XXVI a XXIX – justificativas tecnológica, socioeconômica, ambiental e
          locacional.
        </FormDescription>
        <PcaTextField form={form} name="listagemC.anexosJustificativas.referenciaCroqui" label="Referência ao croqui (Anexo XXV)" />
        <PcaTextField form={form} name="listagemC.anexosJustificativas.referenciaJustificativas" label="Referência às justificativas (Anexos XXVI–XXIX)" />
      </PcaSectionCard>
    </div>
  );
}
