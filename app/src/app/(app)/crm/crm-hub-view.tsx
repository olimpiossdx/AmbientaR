    ...
    <>
      <div className="flex flex-col h-full">
        <PageHeader
          ...
          description="Vis├úo geral de oportunidades, pipeline e desempenho comercial."
        >
        ...
        <main className="flex-1 overflow-auto p-4 md:p-6">
            <Tabs defaultValue="overview" className="space-y-4">
                <TabsList className="grid w-full max-w-md grid-cols-2 h-11">
                    <TabsTrigger value="overview" className="text-sm">Vis├úo Geral</TabsTrigger>
        ...
        <AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
            ...
            <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                Esta a├º├úo n├úo pode ser desfeita. Isso ir├í deletar permanentemente a oportunidade.
                </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
