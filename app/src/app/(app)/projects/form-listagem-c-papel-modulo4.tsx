...
export function FormListagemCPapelModulo4({ form }: { form: any }) {
  ...
  return (
    <div className="space-y-6">
      <SectionCard title="15. Planta de localização">
        <FormDescription>Apresentar planta de localização no Anexo XVIII.</FormDescription>
        <TextField form={form} name="listagemC.papel.anexoPlantaLocalizacao" label="Referência / observações (Anexo XVIII)" />
      </SectionCard>
      ...
      <SectionCard title="17. Caracterização frente à legislação municipal">
        <FormField
          control={form.control}
      ...
      <SectionCard title="18. Tipo de ocupação da área de entorno">
        ...
        <FormDescription>
          Anexo XXIII – planta de uso e ocupação do solo; Anexo XXV – corpos hídricos (ABNT/NBR 6492/1994).
        </FormDescription>
        <TextField form={form} name="listagemC.papel.anexoUsoOcupacaoSolo" label="Referência planta uso/ocupação (Anexo XXIII)" />
      </SectionCard>
      ...
      <SectionCard title="20 e 21. Croqui de acesso e justificativas">
        <FormDescription>
          Anexo XXVI – croqui de acesso; Anexos XXVII a XXX – justificativas tecnológica, técnico/socioeconômica,
          ambiental e locacional.
        </FormDescription>
        <TextField form={form} name="listagemC.papel.anexoCroquiAcesso" label="Referência croqui (Anexo XXVI)" />
        <TextField form={form} name="listagemC.papel.anexoJustificativas" label="Referência justificativas (Anexos XXVII–XXX)" />
      </SectionCard>

      <SectionCard title="22. Caracterização técnica">
        <FormDescription>
          A partir do item 24, apresentar as informações técnicas específicas da indústria de papel e papelão em
          regularização.
        </FormDescription>
      </SectionCard>
      ...
      <SectionCard title="23. Área do empreendimento">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <NumField form={form} name="listagemC.papel.areas.areaTotalM2" label="Área total do terreno (m²)" />
          <NumField form={form} name="listagemC.papel.areas.areaUtilM2" label="Área útil (m²)" />
          <NumField form={form} name="listagemC.papel.areas.areaConstruidaM2" label="Área construída (m²)" />
        </div>
        <FormDescription>
