...
export function ContractsSuppliersListView() {
  ...
  const handleExportPdf = async (item: SupplierContract) => {
    ...
    try {
      ...
      toast({
        ...
        description: "N├úo foi poss├¡vel gerar o PDF do contrato.",
      });
    }
  };
        ...
        <main className="flex-1 overflow-auto p-4 md:p-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Contratante preenchida por Configura├º├Áes &gt; Informa├º├Áes da Empresa e
                prestador selecionado de Financeiro &gt; Fornecedores.
              </CardDescription>
              <CardSearchInput
                value={searchTerm}
                onChange={setSearchTerm}
                placeholder="Buscar n├║mero, contratante, prestador, servi├ºo..."
              />
            </CardHeader>
            <CardContent>
              <TooltipProvider>
                          ...
                          <div className="flex flex-col gap-4">
                            <div className="min-w-0 space-y-2">
                              ...
                              <p className="text-sm text-muted-foreground">
                                {item.contratante?.nome ?? "ÔÇö"}
                                {item.prestador?.nome ? ` ┬À ${item.prestador.nome}` : ""}
                              </p>
                              <p className="text-sm text-muted-foreground">
                                {new Date(item.dataContrato).toLocaleDateString("pt-BR")} ┬À{" "}
      ...
      <Dialog open={isViewOpen} onOpenChange={setIsViewOpen}>
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Detalhes do contrato de presta├º├úo de servi├ºos com fornecedor.
            </DialogDescription>
          </DialogHeader>
          {viewingItem && (
            <div className="space-y-4">
              ...
              <DetailItem label="Descri├º├úo geral" value={viewingItem.objeto?.servicos} />
