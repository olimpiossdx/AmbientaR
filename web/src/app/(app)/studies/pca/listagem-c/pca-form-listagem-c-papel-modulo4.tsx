...
export function PcaFormListagemCPapelModulo4({ form }: { form: any }) {
  ...
  return (
    <div className="space-y-6">
      <PcaSectionCard title="15. Planta de localização">
        ...
        <PcaTextField form={form} name="listagemC.papel.anexoPlantaLocalizacao" label="Referência / observações (Anexo XVIII)" />
      </PcaSectionCard>
      ...
      <PcaSectionCard title="18. Tipo de ocupação da área de entorno">
        ...
        <PcaTextField form={form} name="listagemC.papel.anexoUsoOcupacaoSolo" label="Referência planta uso/ocupação (Anexo XXIII)" />
      </PcaSectionCard>
      ...
      <PcaSectionCard title="20 e 21. Croqui de acesso e justificativas">
        ...
        <PcaTextField form={form} name="listagemC.papel.anexoCroquiAcesso" label="Referência croqui (Anexo XXVI)" />
        <PcaTextField form={form} name="listagemC.papel.anexoJustificativas" label="Referência justificativas (Anexos XXVII–XXX)" />
      </PcaSectionCard>
      ...
      <PcaSectionCard title="23. Área do empreendimento">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <PcaNumField form={form} name="listagemC.papel.areas.areaTotalM2" label="Área total do terreno (m²)" />
          <PcaNumField form={form} name="listagemC.papel.areas.areaUtilM2" label="Área útil (m²)" />
          <PcaNumField form={form} name="listagemC.papel.areas.areaConstruidaM2" label="Área construída (m²)" />
        </div>
        <FormDescription>
