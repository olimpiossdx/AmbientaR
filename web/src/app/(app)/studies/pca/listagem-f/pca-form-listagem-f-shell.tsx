...
import { PCA_LISTAGEM_F_SUBACTIVITIES } from '@/lib/pca/pca-listagem-f-catalog';

type PcaFormListagemFShellProps = {
...
export function PcaFormListagemFShell({
  form,
  clients,
  projects,
  isLoadingClients,
      ...
      <AccordionItem value="identificacao">
        ...
        <AccordionContent className="space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Subatividade (Listagem F)</FormLabel>
                <Select onValueChange={field.onChange} value={field.value}>
                  ...
                  <SelectContent>
                    {PCA_LISTAGEM_F_SUBACTIVITIES.map((opt) => (
