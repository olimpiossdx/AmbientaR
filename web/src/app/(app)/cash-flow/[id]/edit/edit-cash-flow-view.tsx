...
const TransactionForm = dynamic(
  () => import('../../transaction-form').then((m) => ({ default: m.TransactionForm })),
  {
...
function EditTransactionPageContent() {
        ...
        <main className="flex-1 overflow-auto p-4 md:p-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Abra a edição pelo menu de receitas ou despesas (parâmetro type=revenue ou
                type=expense).
              </CardDescription>
            </CardHeader>
          </Card>
  ...
  const description =
    transactionType === 'revenue'
      ? 'Atualize os detalhes do lançamento de receita.'
      : 'Atualize os detalhes do lançamento de despesa.';
...
export function EditCashFlowView() {
  return (
