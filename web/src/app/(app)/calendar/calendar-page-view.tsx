...
const getEventTypeLabel = (type: CalendarEvent['type']) => {
    switch (type) {
        case 'appointment': return 'Reuni├úo';
             ...
             <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  Pr├│ximos Compromissos (15 dias)
                </CardTitle>
                <CardDescription>
                  Uma vis├úo geral dos seus pr├│ximos eventos.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {isLoading && (
                ...
                {!isLoading && upcomingEvents.length > 0 ? (
                  ...
                  <p className="text-sm text-muted-foreground text-center py-4">Nenhum compromisso nos pr├│ximos 15 dias.</p>
                ) : null}
              </CardContent>
            </Card>
          </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta a├º├úo n├úo pode ser desfeita e ir├í deletar o compromisso permanentemente.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
