...
function parseNavigationConfig() {
  ...
  const modulePrefixes = [
    ...
    { module: "Documentos Ambientais", prefixes: ["/documentos-ambientais", "/car", "/compliance", "/intervencoes", "/fauna", "/licenses", "/monitoring", "/outorgas", "/usos-insignificantes", "/inspections/reports"] },
