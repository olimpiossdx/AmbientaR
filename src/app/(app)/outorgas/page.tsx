...
import { MoreHorizontal, PlusCircle, Paperclip, Eye, Pencil, Trash2, Upload } from 'lucide-react';
        ...
        <DialogContent className="sm:max-w-2xl">
          ...
          {viewingItem && (
            <div className="space-y-4 py-4 text-sm">
                ...
                {viewingItem.fileUrl && <div className="space-y-1"><Label>Anexo</Label><p><Tooltip><TooltipTrigger asChild><a href={viewingItem.fileUrl} target="_blank" rel="noreferrer" download className="text-primary underline flex items-center gap-2"><Paperclip className="h-4 w-4" />Ver documento</a></TooltipTrigger><TooltipContent><p>Fazer download</p></TooltipContent></Tooltip></p></div>}
            </div>
          )}
          <DialogFooter>
            <DialogClose asChild>
