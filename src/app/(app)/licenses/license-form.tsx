...
export function LicenseForm({ currentLicense, onSuccess, hideHeader }: LicenseFormProps) {
  ...
  }, [currentLicense?.id, currentLicense?.empreendedorId, currentLicense?.projectId, currentLicense?.permitType, currentLicense?.status, form]);
                    ...
                    <TooltipProvider>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <FormLabel className="cursor-help">Anexar Documento da Licença</FormLabel>
                            </TooltipTrigger>
