                    ...
                    <TableRow key={license.id}>
                      ...
                      <TableCell className="text-right">
                          <div className="flex items-center justify-end gap-1">
                            ...
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <Button variant="ghost" size="icon" onClick={handleGoToCondicionantes}>
        ...
        <DialogContent className="sm:max-w-2xl">
          ...
          {viewingLicense && (
            <div className="space-y-4 py-4 text-sm">
                ...
                {viewingLicense.fileUrl && <div className="space-y-1"><Label>Anexo</Label><p><Tooltip><TooltipTrigger asChild><a href={viewingLicense.fileUrl} target="_blank" rel="noreferrer" download className="text-primary underline flex items-center gap-2"><Paperclip className="h-4 w-4" />Ver documento</a></TooltipTrigger><TooltipContent><p>Fazer download</p></TooltipContent></Tooltip></p></div>}
            </div>
          )}
          <DialogFooter>
            <DialogClose asChild>
