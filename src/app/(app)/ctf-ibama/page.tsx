        ...
        <main className="flex-1 overflow-auto p-4 md:p-6 space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Carregue o Cartão de Cadastro CTF/IBAMA e mantenha atualizado o
              ...
              <CardSearchInput
                ...
                placeholder="Buscar empreendedor, CPF/CNPJ ou nº CTF..."
              />
            </CardHeader>
            <CardContent>
              <TooltipProvider>
                          ...
                          <CardContent className="p-4 sm:p-5">
                            <div className="flex flex-col gap-4">
                              <div className="min-w-0 space-y-2">
                                ...
                                <p className="text-sm text-muted-foreground">
                                  CTF/IBAMA: {emp.ctfIbama?.trim() || "Não informado"}
                                  {emp.ctfIbamaCertificadoValidade
                                    ? ` · Validade: ${formatCtfDateBr(emp.ctfIbamaCertificadoValidade)}`
                                    : ""}
                                </p>
      ...
      <Dialog open={isViewOpen} onOpenChange={setIsViewOpen}>
        <DialogContent className="max-w-lg max-h-[92vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              {viewingEmpreendedor
                ? `CTF/IBAMA — ${viewingEmpreendedor.name}`
                : "CTF/IBAMA"}
            </DialogTitle>
            <DialogDescription>
              Cartão de Cadastro e Certificado de Regularidade vinculados ao empreendedor.
            </DialogDescription>
          </DialogHeader>
          {viewingEmpreendedor && (
            <div className="space-y-6">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {viewingEmpreendedor.cpfCnpj || "Não informado"}
                  </p>
                </div>
              </div>
              ...
              <AttachmentPreviewSection
                ...
                emptyLabel="Cartão de cadastro não enviado."
                sectionLabel="Cartão de Cadastro"
                zoomTitle="Cartão de Cadastro CTF/IBAMA"
              />
              <AttachmentPreviewSection
                fileUrl={viewingEmpreendedor.ctfIbamaCertificadoUrl}
                emptyLabel="Certificado de regularidade não enviado."
