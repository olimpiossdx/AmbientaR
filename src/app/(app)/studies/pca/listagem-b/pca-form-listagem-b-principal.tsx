...
export function PcaFormListagemBPrincipal({ form, hideEspecifico, slotEspecifico }: PcaFormListagemBComumProps) {
  ...
  const { fields: atividadePrincipalFields, append: appendAtividadePrincipal, remove: removeAtividadePrincipal } =
    useFieldArray({ control: form.control, name: 'listagemB.atividadesPrincipal' as never });
  const { fields: outrasAtividadesFields, append: appendOutrasAtividades, remove: removeOutrasAtividades } =
    useFieldArray({ control: form.control, name: 'listagemB.outrasAtividades' as never });
  const { fields: nucleoPopulacionalFields, append: appendNucleoPopulacional, remove: removeNucleoPopulacional } =
    useFieldArray({ control: form.control, name: 'listagemB.legislacaoMunicipal.nucleosPopulacionais' as never });
  const { fields: ocupacaoEntornoFields, append: appendOcupacaoEntorno, remove: removeOcupacaoEntorno } =
    useFieldArray({ control: form.control, name: 'listagemB.ocupacaoEntorno.ocorrencias' as never });
  const { fields: recursosHidricosFields, append: appendRecursosHidricos, remove: removeRecursosHidricos } =
    useFieldArray({ control: form.control, name: 'listagemB.recursosHidricos.intervencoes' as never });
  const { fields: turnosFields, append: appendTurno, remove: removeTurno } =
    useFieldArray({ control: form.control, name: 'listagemB.regimeOperacao.turnos' as never });
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4 rounded-md border p-4">
        ...
        {atividadePrincipalFields.map((item, index) => (
          <div key={item.id} className="grid grid-cols-1 gap-3 rounded-md border p-3 md:grid-cols-5">
            <FormField control={form.control} name={`listagemB.atividadesPrincipal.${index}.atividade`} render={({ field }) => (<FormItem><FormLabel>Atividade principal</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.atividadesPrincipal.${index}.codigo`} render={({ field }) => (<FormItem><FormLabel>Código DN-217/2017</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.atividadesPrincipal.${index}.parametroUnidade`} render={({ field }) => (<FormItem><FormLabel>Parâmetro/Unidade</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.atividadesPrincipal.${index}.quantidade`} render={({ field }) => (<FormItem><FormLabel>Quantidade</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.atividadesPrincipal.${index}.inicioAtividade`} render={({ field }) => (<FormItem><FormLabel>Início da atividade</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
      ...
      <div className="space-y-4 rounded-md border p-4">
        ...
        {outrasAtividadesFields.map((item, index) => (
          <div key={item.id} className="grid grid-cols-1 gap-3 rounded-md border p-3 md:grid-cols-5">
            <FormField control={form.control} name={`listagemB.outrasAtividades.${index}.atividade`} render={({ field }) => (<FormItem><FormLabel>Especificar atividades</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.outrasAtividades.${index}.codigo`} render={({ field }) => (<FormItem><FormLabel>Código DN-217/2017</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.outrasAtividades.${index}.parametroUnidade`} render={({ field }) => (<FormItem><FormLabel>Parâmetro/Unidade</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.outrasAtividades.${index}.quantidade`} render={({ field }) => (<FormItem><FormLabel>Quantidade</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.outrasAtividades.${index}.inicioAtividade`} render={({ field }) => (<FormItem><FormLabel>Início da atividade</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <div className="md:col-span-5 flex justify-end">
      ...
      <div className="space-y-4 rounded-md border p-4">
        ...
        <FormField
          control={form.control}
          name="listagemB.regularizacaoAmbiental.fase"
          render={({ field }) => (
            <FormItem>
        ...
        />
        <FormField control={form.control} name="listagemB.regularizacaoAmbiental.classe" render={({ field }) => (<FormItem><FormLabel>Classe</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
        <FormField
          control={form.control}
          name="listagemB.regularizacaoAmbiental.ampliacaoEmpreendimentoLicenciado"
          render={({ field }) => (
            <FormItem>
        ...
        {isAmpliacao && (
          <div className="grid grid-cols-1 gap-4 rounded-md border p-3 md:grid-cols-2">
            <FormField control={form.control} name="listagemB.regularizacaoAmbiental.processoUltimaLicenca" render={({ field }) => (<FormItem className="md:col-span-2"><FormLabel>Nº do processo da última licença</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name="listagemB.regularizacaoAmbiental.capacidadeAntes" render={({ field }) => (<FormItem><FormLabel>Capacidade antes (t/dia)</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name="listagemB.regularizacaoAmbiental.capacidadeDepois" render={({ field }) => (<FormItem><FormLabel>Capacidade prevista após ampliação (t/dia)</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name="listagemB.regularizacaoAmbiental.empregadosAntes" render={({ field }) => (<FormItem><FormLabel>Empregados antes</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name="listagemB.regularizacaoAmbiental.empregadosDepois" render={({ field }) => (<FormItem><FormLabel>Empregados previstos após ampliação</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name="listagemB.regularizacaoAmbiental.areaUtilAntes" render={({ field }) => (<FormItem><FormLabel>Área útil antes (ha)</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name="listagemB.regularizacaoAmbiental.areaUtilDepois" render={({ field }) => (<FormItem><FormLabel>Área útil prevista após ampliação (ha)</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
          </div>
        )}
      </div>
      ...
      <div className="space-y-4 rounded-md border p-4">
        ...
        <FormField
          control={form.control}
          name="listagemB.restricoesLocacionais.descricaoRemanescenteVegetacao"
          render={({ field }) => (
            <FormItem>
      ...
      <div className="space-y-4 rounded-md border p-4">
        ...
        />
        <FormField control={form.control} name="listagemB.app.existeApp" render={({ field }) => (<FormItem><FormLabel>Existe APP no terreno?</FormLabel><FormControl><BooleanRadio value={field.value} onChange={field.onChange} /></FormControl></FormItem>)} />
        {form.watch('listagemB.app.existeApp') && (
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <FormField control={form.control} name="listagemB.app.areaHa" render={({ field }) => (<FormItem><FormLabel>Quantificação da área APP (ha)</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name="listagemB.app.situacaoCobertura" render={({ field }) => (<FormItem><FormLabel>Situação da cobertura vegetal</FormLabel><FormControl><Input placeholder="Preservada / protegida / outra" {...field} /></FormControl></FormItem>)} />
          </div>
        )}
      </div>
      ...
      <div className="space-y-4 rounded-md border p-4">
        ...
        {recursosHidricosFields.map((item, index) => (
          <div key={item.id} className="grid grid-cols-1 gap-3 rounded-md border p-3 md:grid-cols-6">
            <FormField control={form.control} name={`listagemB.recursosHidricos.intervencoes.${index}.tipo`} render={({ field }) => (<FormItem><FormLabel>Tipo de intervenção</FormLabel><FormControl><Input placeholder="Poço tubular / captação etc." {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.recursosHidricos.intervencoes.${index}.volume`} render={({ field }) => (<FormItem><FormLabel>Volume (m3/mês)</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.recursosHidricos.intervencoes.${index}.outorgada`} render={({ field }) => (<FormItem><FormLabel>Outorgada?</FormLabel><FormControl><Input placeholder="Sim/Não" {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.recursosHidricos.intervencoes.${index}.orgao`} render={({ field }) => (<FormItem><FormLabel>Órgão</FormLabel><FormControl><Input placeholder="IGAM/ANA" {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.recursosHidricos.intervencoes.${index}.portaria`} render={({ field }) => (<FormItem><FormLabel>Portaria Nº</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.recursosHidricos.intervencoes.${index}.processo`} render={({ field }) => (<FormItem><FormLabel>Processo Nº</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
      ...
      <div className="space-y-4 rounded-md border p-4">
        ...
        <FormField control={form.control} name="listagemB.legislacaoMunicipal.temPlanoDiretor" render={({ field }) => (<FormItem><FormLabel>Município tem Plano Diretor / Lei de Uso e Ocupação do Solo?</FormLabel><FormControl><BooleanRadio value={field.value} onChange={field.onChange} /></FormControl></FormItem>)} />
        <FormField control={form.control} name="listagemB.legislacaoMunicipal.interfereNucleosPopulacionais" render={({ field }) => (<FormItem><FormLabel>Interfere com núcleos populacionais?</FormLabel><FormControl><BooleanRadio value={field.value} onChange={field.onChange} /></FormControl></FormItem>)} />
        {nucleoPopulacionalFields.map((item, index) => (
          <div key={item.id} className="grid grid-cols-1 gap-3 rounded-md border p-3 md:grid-cols-5">
            <FormField control={form.control} name={`listagemB.legislacaoMunicipal.nucleosPopulacionais.${index}.nome`} render={({ field }) => (<FormItem><FormLabel>Núcleo populacional</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.legislacaoMunicipal.nucleosPopulacionais.${index}.localizacao`} render={({ field }) => (<FormItem><FormLabel>Localização</FormLabel><FormControl><Input placeholder="Urbano/Rural" {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.legislacaoMunicipal.nucleosPopulacionais.${index}.distanciaM`} render={({ field }) => (<FormItem><FormLabel>Distância da rede (m)</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.legislacaoMunicipal.nucleosPopulacionais.${index}.referencia`} render={({ field }) => (<FormItem className="md:col-span-2"><FormLabel>Referência</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <div className="md:col-span-5 flex justify-end">
        ...
        {ocupacaoEntornoFields.map((item, index) => (
          <div key={item.id} className="grid grid-cols-1 gap-3 rounded-md border p-3 md:grid-cols-3">
            <FormField control={form.control} name={`listagemB.ocupacaoEntorno.ocorrencias.${index}.ocorrencia`} render={({ field }) => (<FormItem><FormLabel>Ocorrência</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.ocupacaoEntorno.ocorrencias.${index}.distanciaM`} render={({ field }) => (<FormItem><FormLabel>Distância (m)</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
      ...
      <div className="space-y-4 rounded-md border p-4">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <FormField control={form.control} name="listagemB.recursosHumanos.producao.quantidade" render={({ field }) => (<FormItem><FormLabel>Funcionários - Produção</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
          <FormField control={form.control} name="listagemB.recursosHumanos.administrativo.quantidade" render={({ field }) => (<FormItem><FormLabel>Funcionários - Administrativo</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
          <FormField control={form.control} name="listagemB.recursosHumanos.outrosSetores.quantidade" render={({ field }) => (<FormItem><FormLabel>Funcionários - Outros setores</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
        </div>

        {turnosFields.map((item, index) => (
          <div key={item.id} className="grid grid-cols-1 gap-3 rounded-md border p-3 md:grid-cols-6">
            <FormField control={form.control} name={`listagemB.regimeOperacao.turnos.${index}.setor`} render={({ field }) => (<FormItem><FormLabel>Setor</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.regimeOperacao.turnos.${index}.funcionariosTurno`} render={({ field }) => (<FormItem><FormLabel>Nº funcionários/turno</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.regimeOperacao.turnos.${index}.horarioInicio`} render={({ field }) => (<FormItem><FormLabel>Início</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.regimeOperacao.turnos.${index}.horarioFim`} render={({ field }) => (<FormItem><FormLabel>Fim</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.regimeOperacao.turnos.${index}.pausaInicio`} render={({ field }) => (<FormItem><FormLabel>Pausa início</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <FormField control={form.control} name={`listagemB.regimeOperacao.turnos.${index}.pausaFim`} render={({ field }) => (<FormItem><FormLabel>Pausa fim</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>)} />
            <div className="md:col-span-6 flex justify-end">
        ...
        <FormField
          control={form.control}
          name="listagemB.regimeOperacao.diasOperacao"
          render={({ field }) => (
            <FormItem>
        ...
        <FormField
          control={form.control}
          name="listagemB.regimeOperacao.mesesOperacao"
          render={({ field }) => (
            <FormItem>
      ...
      {slotEspecifico}
      {!hideEspecifico && !slotEspecifico ? <PcaFormListagemBEspecifico form={form} /> : null}
