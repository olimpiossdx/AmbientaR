...
import { PCA_LISTAGEM_G_SUBACTIVITIES } from '@/lib/pca/pca-listagem-g-catalog';

type PcaFormListagemGShellProps = {
...
export function PcaFormListagemGShell({
  form,
  clients,
  projects,
  isLoadingClients,
      ...
      <AccordionItem value="identificacao">
        ...
        <AccordionContent className="space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Subatividade (Listagem G)</FormLabel>
                <Select onValueChange={field.onChange} value={field.value}>
                  ...
                  <SelectContent>
                    {PCA_LISTAGEM_G_SUBACTIVITIES.map((opt) => (
