...
export const pcaListagemGTecnicoSchema = z
  .object({
    ...
    areaEmpreendimento: z
      .object({
        ...
        areaProdutivaHa: z.string().optional(),
        areaPreservacaoHa: z.string().optional(),
      })
      .optional(),
    agropecuaria: z
      .object({
        culturasResumo: z.string().optional(),
        rebanhoResumo: z.string().optional(),
        irrigacao: z.boolean().optional(),
        irrigacaoResumo: z.string().optional(),
      })
      .optional(),
    ...
    recursosHidricos: z
      .object({
        outorga: z.boolean().optional(),
        resumoCaptacao: z.string().optional(),
      })
      .optional(),
    insumosAgroquimicos: z
      .object({
        utiliza: z.boolean().optional(),
        resumoArmazenamento: z.string().optional(),
      })
      .optional(),
    efluentes: z
      .object({
...
export function getPcaListagemGDefaultValues(
  partial?: Partial<PcaListagemGFormValues> | null,
): PcaListagemGFormValues {
  return {
    status: 'Rascunho',
    listagemCode: 'G',
    activity: partial?.activity || PCA_LISTAGEM_G_ACTIVITY,
