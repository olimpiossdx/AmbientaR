...
import { PCA_LISTAGEM_H_SUBACTIVITIES } from '@/lib/pca/pca-listagem-h-catalog';

type PcaFormListagemHShellProps = {
...
export function PcaFormListagemHShell({
  form,
  clients,
  projects,
  isLoadingClients,
      ...
      <AccordionItem value="identificacao">
        ...
        <AccordionContent className="space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Subatividade (Listagem H)</FormLabel>
                <Select onValueChange={field.onChange} value={field.value}>
                  ...
                  <SelectContent>
                    {PCA_LISTAGEM_H_SUBACTIVITIES.map((opt) => (
