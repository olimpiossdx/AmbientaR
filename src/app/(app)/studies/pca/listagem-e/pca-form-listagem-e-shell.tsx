...
import { PCA_LISTAGEM_E_SUBACTIVITIES } from '@/lib/pca/pca-listagem-e-catalog';

type PcaFormListagemEShellProps = {
...
export function PcaFormListagemEShell({
  form,
  clients,
  projects,
  isLoadingClients,
      ...
      <AccordionItem value="identificacao">
        ...
        <AccordionContent className="space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Subatividade (Listagem E)</FormLabel>
                <Select onValueChange={field.onChange} value={field.value}>
                  ...
                  <SelectContent>
                    {PCA_LISTAGEM_E_SUBACTIVITIES.map((opt) => (
