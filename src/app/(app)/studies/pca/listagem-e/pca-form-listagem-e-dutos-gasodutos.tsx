...
import { PcaFormListagemEEspecifico } from './pca-form-listagem-e-especifico';
import { PcaFormListagemEEmpreendedor } from './pca-form-listagem-e-empreendedor';
import { PcaFormListagemEGeoTrecho } from './pca-form-listagem-e-geo-trecho';
import { PcaFormListagemESecao6 } from './pca-form-listagem-e-secao6';
interface PcaFormListagemEComumProps {
  form: any;
}

export function PcaFormListagemEDutosGasodutos({ form }: PcaFormListagemEComumProps) {
  ...
  const { fields: outrasAtividadesFields, append: appendOutrasAtividades, remove: removeOutrasAtividades } =
    useFieldArray({ control: form.control, name: 'listagemE.outrasAtividades' as never });
  return (
    <div className="space-y-6">
      ...
      <PcaFormListagemEGeoTrecho form={form} />

      <PcaFormListagemESecao6 form={form} />
...
<div className="space-y-4 rounded-md border p-4">
      ...
      <PcaFormListagemEEspecifico form={form} />
