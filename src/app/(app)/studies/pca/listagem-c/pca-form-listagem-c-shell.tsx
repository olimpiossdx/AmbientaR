...
import { PcaTextField, PcaTextAreaField, PcaCoordenadasReadOnlyField } from '../listagem-a/pca-form-listagem-a-helpers';
import type { PcaListagemCFormValues } from './pca-listagem-c-schema';
import { PCA_LISTAGEM_C_SUBACTIVITIES } from '@/lib/pca/pca-listagem-c-catalog';

type PcaFormListagemCShellProps = {
...
export function PcaFormListagemCShell({
  form,
  clients,
  projects,
  isLoadingClients,
    ...
    <Accordion type="multiple" defaultValue={['identificacao', 'empreendimento']} className="w-full">
      <AccordionItem value="identificacao">
        ...
        <AccordionContent className="space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Subatividade (Listagem C)</FormLabel>
                <Select onValueChange={field.onChange} value={field.value}>
                  ...
                  <SelectContent>
                    {PCA_LISTAGEM_C_SUBACTIVITIES.map((opt) => (
      ...
      <AccordionItem value="empreendimento">
        ...
        <AccordionContent className="space-y-4">
          ...
          <PcaCoordenadasReadOnlyField form={form as never} />
          <div className="grid gap-4 md:grid-cols-2">
