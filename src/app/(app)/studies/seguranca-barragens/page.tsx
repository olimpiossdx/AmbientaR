...
export default function SegurancaBarragensPage() {
  ...
  const handleAddNew = () => {
    // router.push('/studies/seguranca-barragens/new');
  };

  return (
    <div className="flex flex-col h-full">
      <PageHeader title="Segurança de Barragens">
      ...
      <main className="flex-1 overflow-auto p-4 md:p-6 space-y-8">
        <Card>
          <CardHeader>
            <CardTitle>Estudos em Elaboração</CardTitle>
            ...
            <Table>
              ...
              <TableBody>
                {isLoading ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={4} className="h-24 text-center">Nenhum estudo em elaboração.</TableCell>
                  </TableRow>
                )}
              </TableBody>
            </Table>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Estudos Aprovados</CardTitle>
             ...
             <Table>
              ...
              <TableBody>
                 {isLoading ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={4} className="h-24 text-center">Nenhum estudo aprovado.</TableCell>
                  </TableRow>
                )}
              </TableBody>
            </Table>
