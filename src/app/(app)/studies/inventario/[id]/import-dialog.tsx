    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-7xl h-[90vh] flex flex-col p-0 gap-0">
        <DialogHeader className="p-4 border-b">
          ...
          <DialogDescription>
            Siga os passos para importar os dados da sua planilha para o
            sistema.
          </DialogDescription>
        </DialogHeader>
            ...
            {currentStep === 0 && (
              <>
                ...
                <div className="mt-4 flex-1 border rounded-md overflow-hidden flex flex-col">
                  <div className="p-2 bg-muted border-b text-sm font-medium">
                    Dados da Planilha
                  </div>
        ...
        <DialogFooter className="p-4 border-t bg-muted/50 justify-between">
          ...
          <div>
            ...
            {currentStep > 0 && (
              <Button variant="outline" className="ml-2" onClick={handleBack}>
                Voltar
              </Button>
            )}
