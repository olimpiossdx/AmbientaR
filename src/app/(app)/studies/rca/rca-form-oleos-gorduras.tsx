...
interface RcaFormOleosGordurasProps {
    form: any;
    clients: Client[];
...
export function RcaFormOleosGorduras({ form, clients, isLoadingClients, projects, isLoadingProjects }: RcaFormOleosGordurasProps) {
            ...
            <AccordionItem value="item-4">
                ...
                <AccordionContent className="space-y-6 p-1">
                    <div className="space-y-4 p-4 border rounded-md">
                        <h3 className="font-semibold">23. RECURSOS HUMANOS</h3>
                     ...
                     <div className="space-y-4 p-4 border rounded-md">
                        <h3 className="font-semibold">25. MATÉRIAS PRIMAS PRINCIPAIS</h3>
                    ...
                    <div className="space-y-4 p-4 border rounded-md">
                        <h3 className="font-semibold">27. PRODUTOS ACABADOS</h3>
                        <div className="flex justify-end">
                     ...
                     <div className="space-y-4 p-4 border rounded-md">
                        <div className="flex justify-between items-center"><h3 className="font-semibold">31. EQUIPAMENTOS</h3><Button size="sm" type="button" onClick={() => appendEquipamento({})}><PlusCircle className="mr-2 h-4 w-4" /> Add</Button></div>
