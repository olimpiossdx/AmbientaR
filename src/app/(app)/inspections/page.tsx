    ...
    try {
        ...
        if (projectInfo?.userId) {
            await createNotificationForUser(firestore, projectInfo.userId, {
                ...
                description: `O relatório para o empreendimento "${projectInfo.name}" foi aprovado. Confirme a leitura em Relatórios de Vistoria.`,
                        ...
                        <TableRow key={inspection.id}>
                          ...
                          <TableCell className="text-right">
                            <div className="flex items-center justify-end gap-1">
                                ...
                                <Tooltip><TooltipTrigger asChild><Button variant="ghost" size="icon" onClick={() => handleEdit(inspection)}><Pencil className="h-4 w-4" /></Button></TooltipTrigger><TooltipContent><p>Editar a fiscalização</p></TooltipContent></Tooltip>
