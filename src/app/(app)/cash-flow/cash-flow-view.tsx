...
export function CashFlowView(props: CashFlowViewProps) {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <main className="flex-1 space-y-4 overflow-auto p-4 md:p-6">
        <CashFlowSummary />
        ...
        {canWrite && (
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <Button
              ...
              onClick={() => router.push('/cash-flow/new?type=revenue')}
            >
            ...
            <Button
              ...
              variant="destructive"
              className="h-12 gap-2 text-base"
              onClick={() => router.push('/cash-flow/new?type=expense')}
            >
              <Plus className="h-5 w-5 shrink-0" aria-hidden />
              + Nova Despesa
            </Button>
        ...
        <Card className="mb-4 border-border/60 bg-muted/30 shadow-sm">
          <CardHeader className="space-y-1 pb-2 pt-4">
            ...
            <CardDescription className="text-xs sm:text-sm">
              Refine a lista por cliente (receitas), texto, datas e faixa de
              valores.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="border-border/60 bg-muted/30 shadow-sm">
          <CardHeader className="space-y-1 pb-2 pt-4">
            ...
            <CardDescription className="text-xs sm:text-sm">
              O período abaixo define o conteúdo do PDF e da impressão (receitas
              e despesas nesse intervalo).
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-0">
          ...
          <TabsContent value="revenues">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Adicione, edite e visualize todas as entradas de caixa.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <RevenueTable
          ...
          <TabsContent value="expenses">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Adicione, edite e visualize todas as saídas de caixa.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ExpenseTable
