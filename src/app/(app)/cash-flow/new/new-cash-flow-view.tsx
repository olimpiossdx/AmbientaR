...
function NewTransactionPageContent() {
  ...
  const description =
    transactionType === 'revenue'
      ? 'Preencha os detalhes para criar um novo lançamento de receita.'
      : 'Preencha os detalhes para criar um novo lançamento de despesa.';
...
export function NewCashFlowView() {
  return (
