...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "min-w-0 max-w-full break-words rounded-lg border bg-card text-card-foreground shadow-sm",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "min-w-0 break-words text-xl font-semibold leading-tight tracking-tight sm:text-2xl",
      className
    )}
    {...props}
  />
