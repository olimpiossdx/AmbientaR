 ...
 * Inclui vínculos explícitos (linkedClientId / linkedEmpreendedorId) e
 * registros com `userId` do titular (myClients / myEmpreendedores).
 */
 ...
 * empreendimentos vinculados (linked) ou com userId do titular.
 */
export function buildTitularAccessMatchDocumentSet(input: {
  ...
  return buildTitularCpfCnpjSet({
    ...
    myClients: input.myClients,
    myEmpreendedores: input.myEmpreendedores,
    clientById: input.clientById,
    empreendedorById: input.empreendedorById,
